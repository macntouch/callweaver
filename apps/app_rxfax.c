...
CALLWEAVER_FILE_VERSION("$HeadURL: https://svn.callweaver.org/callweaver/branches/rel/1.2/apps/app_rxfax.c $", "$Revision: 5346 $")
...
static void *fax_app;
static const char *fax_name = "RxFAX";
static const char *fax_synopsis = "Receive a FAX to a file";
static const char *fax_syntax = "RxFAX(filename[, caller][, debug])";
