...
CALLWEAVER_FILE_VERSION("$HeadURL: https://svn.callweaver.org/callweaver/branches/rel/1.2/codecs/codec_g722_16k_8k.c $", "$Revision: 5229 $")
...
static struct cw_frame *g722tolin_frameout(struct cw_translator_pvt *pvt)
{
    struct g722_decoder_pvt *tmp = (struct g722_decoder_pvt *) pvt;
...
static int lintog722_framein(struct cw_translator_pvt *pvt, struct cw_frame *f)
{
 ...
 *  None.
 */
static void g722_destroy(struct cw_translator_pvt *pvt)
{
    free(pvt);
    localusecnt--;
    cw_update_use_count();
 ...
 */
static struct cw_translator g722tolin =
{
    "g722tolin8k",
    CW_FORMAT_G722,
    16000,
 ...
 */
static struct cw_translator lintog722 =
{
    "lin8ktog722",
    CW_FORMAT_SLINEAR,
    8000,
...
int load_module(void)
{
    ...
    parse_config();
    if ((res = cw_register_translator(&g722tolin)) == 0)
        res = cw_register_translator(&lintog722);
    else
        cw_unregister_translator(&g722tolin);
    return res;
}
